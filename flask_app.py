...
# flask_app.py - បន្ថែមនៅដើមឯកសារ បន្ទាប់ពី import

# ============================================================
# MONGODB CONNECTION (Override SQLite functions)
# ============================================================
...
if USE_MONGODB:
    ...
    from mongo_db import (
        init_db as mongo_init_db,
        get_data_version as mongo_get_data_version,
        increment_data_version as mongo_increment_data_version,
        get_user_by_id as mongo_get_user_by_id,
        get_user_by_username as mongo_get_user_by_username,
        create_user as mongo_create_user,
        update_user as mongo_update_user,
        update_password as mongo_update_password,
        verify_password as mongo_verify_password,
        delete_user as mongo_delete_user,
        get_all_users as mongo_get_all_users,
        save_company_location as mongo_save_company_location,
        get_company_location as mongo_get_company_location,
        check_in as mongo_check_in,
        check_out as mongo_check_out,
        get_checkin_status as mongo_get_checkin_status,
        get_system_lock_status as mongo_get_system_lock_status,
        update_system_lock as mongo_update_system_lock,
        toggle_system_lock as mongo_toggle_system_lock,
        get_user_lock_status as mongo_get_user_lock_status,
        update_user_lock as mongo_update_user_lock,
        get_all_user_lock_status as mongo_get_all_user_lock_status,
        get_attendance_stats as mongo_get_attendance_stats,
        get_all_attendance as mongo_get_all_attendance,
        get_work_history_report as mongo_get_work_history_report,
        get_monthly_summary_report as mongo_get_monthly_summary_report,
        get_attendance_setting as mongo_get_attendance_setting,
        save_attendance_setting as mongo_save_attendance_setting,
        get_all_attendance_settings as mongo_get_all_attendance_settings,
        create_leave as mongo_create_leave,
        get_pending_leaves as mongo_get_pending_leaves,
        approve_leave as mongo_approve_leave,
        reject_leave as mongo_reject_leave,
        create_mission as mongo_create_mission,
        get_pending_missions as mongo_get_pending_missions,
        approve_mission as mongo_approve_mission,
        reject_mission as mongo_reject_mission,
        clean_all_data as mongo_clean_all_data,
        clean_attendance_only as mongo_clean_attendance_only,
        clean_leaves_only as mongo_clean_leaves_only,
        clean_missions_only as mongo_clean_missions_only,
        get_current_date as mongo_get_current_date,
        get_current_datetime as mongo_get_current_datetime,
        get_current_time as mongo_get_current_time,
        get_current_time_only as mongo_get_current_time_only,
        get_current_datetime_str as mongo_get_current_datetime_str,
        get_attendance_report as mongo_get_attendance_report,
        get_attendance_by_id as mongo_get_attendance_by_id,
        update_attendance as mongo_update_attendance,
        delete_attendance as mongo_delete_attendance,
        check_attendance_deadline as mongo_check_attendance_deadline,
        check_system_lock_for_user as mongo_check_system_lock_for_user,
        check_user_lock as mongo_check_user_lock
    )
    
    # Override functions with MongoDB versions
    init_db = mongo_init_db
    get_data_version = mongo_get_data_version
    increment_data_version = mongo_increment_data_version
    get_user_by_id = mongo_get_user_by_id
    get_user_by_username = mongo_get_user_by_username
    create_user = mongo_create_user
    update_user = mongo_update_user
    update_password = mongo_update_password
    verify_password = mongo_verify_password
    delete_user = mongo_delete_user
    get_all_users = mongo_get_all_users
    save_company_location = mongo_save_company_location
    get_company_location = mongo_get_company_location
    check_in = mongo_check_in
    check_out = mongo_check_out
    get_checkin_status = mongo_get_checkin_status
    get_system_lock_status = mongo_get_system_lock_status
    update_system_lock = mongo_update_system_lock
    toggle_system_lock = mongo_toggle_system_lock
    get_user_lock_status = mongo_get_user_lock_status
    update_user_lock = mongo_update_user_lock
    get_all_user_lock_status = mongo_get_all_user_lock_status
    get_attendance_stats = mongo_get_attendance_stats
    get_all_attendance = mongo_get_all_attendance
    get_work_history_report = mongo_get_work_history_report
    get_monthly_summary_report = mongo_get_monthly_summary_report
    get_attendance_setting = mongo_get_attendance_setting
    save_attendance_setting = mongo_save_attendance_setting
    get_all_attendance_settings = mongo_get_all_attendance_settings
    create_leave = mongo_create_leave
    get_pending_leaves = mongo_get_pending_leaves
    approve_leave = mongo_approve_leave
    reject_leave = mongo_reject_leave
    create_mission = mongo_create_mission
    get_pending_missions = mongo_get_pending_missions
    approve_mission = mongo_approve_mission
    reject_mission = mongo_reject_mission
    clean_all_data = mongo_clean_all_data
    clean_attendance_only = mongo_clean_attendance_only
    clean_leaves_only = mongo_clean_leaves_only
    clean_missions_only = mongo_clean_missions_only
    get_current_date = mongo_get_current_date
    get_current_datetime = mongo_get_current_datetime
    get_current_time = mongo_get_current_time
    get_current_time_only = mongo_get_current_time_only
    get_current_datetime_str = mongo_get_current_datetime_str
    get_attendance_report = mongo_get_attendance_report
    get_attendance_by_id = mongo_get_attendance_by_id
    update_attendance = mongo_update_attendance
    delete_attendance = mongo_delete_attendance
    check_attendance_deadline = mongo_check_attendance_deadline
    check_system_lock_for_user = mongo_check_system_lock_for_user
    check_user_lock = mongo_check_user_lock
else:
    print("⚠️ Using SQLite (MONGO_URI not set)")
    # រក្សា SQLite functions ដើម
