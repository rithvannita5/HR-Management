...
# flask_app.py - Part 1: Imports and MongoDB Connection
from flask import Flask, request, redirect, url_for, session, render_template_string, jsonify, send_file, send_from_directory
import os
import math
import datetime
...
# ============================================================
# MONGODB CONNECTION - IMPORT ALL FUNCTIONS
# ============================================================
...
# flask_app.py - Part 2: Routes (Login, Dashboard, Data Version, Checkin Status, System Lock)
...
# flask_app.py - Part 3: Check In / Check Out Routes
...
# flask_app.py - Part 4: User Management Routes
...
# flask_app.py - Part 5: Leave, Mission, Request Routes
...
def reject_request():
    try:
        ...
        traceback.print_exc()
        return jsonify({'success': False, 'message': f'កំហុស: {str(e)}'})
# flask_app.py - Part 6: Report, Export Excel, Auto Unlock
...
# flask_app.py - Part 7: PWA, Static Routes, Edit/Delete Attendance, Login, Logout
